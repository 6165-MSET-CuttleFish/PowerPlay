...
public class RightSideHighMS extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory preload2 = robot.trajectoryBuilder(preload1.end())
                .lineToLinearHeading(new Pose2d(-35.25,13, Math.toRadians(174.5)))
                ...
                .build();
        Trajectory initIntake = robot.trajectoryBuilder(new Pose2d(-35.25,13, Math.toRadians(180)))
        ...
        Trajectory cycleDrop = robot.trajectoryBuilder(initIntake.end())
                .lineToConstantHeading(new Vector2d(-36.4, 12.5),robot.getVelocityConstraint(58, 5.939, 13.44),
