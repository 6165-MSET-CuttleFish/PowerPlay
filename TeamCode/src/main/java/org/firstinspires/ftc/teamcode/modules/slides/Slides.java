...
public class Slides extends HwModule {
    ...
    public static int HIGH = 1695; //old = 1850
    public static int CYCLE_HIGH = 1770; //old = 1650
    public static int MID = 1145; //in inches, 23.5 - 17.5 (mid junction height - slides height)
