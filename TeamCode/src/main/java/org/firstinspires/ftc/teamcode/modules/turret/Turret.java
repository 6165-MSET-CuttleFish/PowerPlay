...
public class Turret extends HwModule
{
    ...
    public static int LEFT_POS = 2100, RIGHT_POS = -2100, ZERO_POS = 0, INIT=1020,
            BACK = 4125, RIGHT_DIAGONAL = -3000, LEFT_DIAGONAL = 3000,  RIGHT_SIDE_HIGH = -2775,
            RIGHT_SIDE_HIGH_PRELOAD = -915, RIGHT_SIDE_MID_PRELOAD = -3200, RIGHT_SIDE_MID = 3100, LEFT_SIDE_HIGH_PRELOAD = 1090, LEFT_SIDE_HIGH = 2820,LEFT_SIDE_MID = -3100,LEFT_SIDE_MID_PRELOAD = 3200;
