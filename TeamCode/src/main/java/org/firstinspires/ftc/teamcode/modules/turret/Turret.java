...
public class Turret extends HwModule
{
    ...
    public static int LEFT_POS = 2100, RIGHT_POS = -2100, ZERO_POS = 0, INIT=1020,
            BACK = 4125, RIGHT_DIAGONAL = -3000, LEFT_DIAGONAL = 3000,  RIGHT_SIDE_HIGH = -3020,
            RIGHT_SIDE_HIGH_PRELOAD = -910, RIGHT_SIDE_MID_PRELOAD = -3200, RIGHT_SIDE_MID = 3100, LEFT_SIDE_HIGH_PRELOAD = 900, LEFT_SIDE_HIGH = 2950,LEFT_SIDE_MID = -3100,LEFT_SIDE_MID_PRELOAD = 3200;
