...
@Right
public class LeftSideMidAntiSlam extends LinearOpMode {
    ElapsedTime t;
    Robot robot;
    Intake intake;
    Slides slides;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory initIntake = robot.trajectoryBuilder(preload2.end())
                .splineToConstantHeading(new Vector2d(50, 13.5), Math.toRadians(0),
        ...
        Trajectory intaking = robot.trajectoryBuilder(initIntake.end())
                .splineToConstantHeading(new Vector2d(54.5, 13.5), Math.toRadians(0),
