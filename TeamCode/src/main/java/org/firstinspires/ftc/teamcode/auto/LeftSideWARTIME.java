...
@Autonomous
@Left
public class LeftSideWARTIME extends LinearOpMode {
    ElapsedTime t;
    Robot robot;
    Intake intake;
    Slides slides;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory wartime = robot.trajectoryBuilder(startPose)
                .lineToConstantHeading(new Vector2d(38, 8),robot.getVelocityConstraint(55, 5.939, 13.44),
                ...
                .build();
        Trajectory preload1 = robot.trajectoryBuilder(wartime.end())
                .lineToConstantHeading(new Vector2d(37, 12.2),robot.getVelocityConstraint(30, 5.939, 13.44),
        ...
        Trajectory preload2 = robot.trajectoryBuilder(preload1.end())
                .lineToLinearHeading(new Pose2d(35.5,13, Math.toRadians(5.5)))
                ...
                .build();
        Trajectory initIntake = robot.trajectoryBuilder(new Pose2d(35.5,13, Math.toRadians(0)))
                .lineToConstantHeading(new Vector2d(56.5, 12),robot.getVelocityConstraint(47.5, 5.939, 13.44),
        ...
        Trajectory cycleDrop = robot.trajectoryBuilder(initIntake.end())
                .lineToConstantHeading(new Vector2d(35.5, 12),robot.getVelocityConstraint(47.5, 5.939, 13.44),
                        robot.getAccelerationConstraint(50))
                .addTemporalMarker(0, ()->{
